const clientId ="a68a80ab4fd34e5a915f2dc6729fbaec";
const redirectUri="http://localhost:3000"; //this redirect url have to add this accepted spotify redirect URLs on the spotify API.
let accessToken;
...
const Spotify={
    getAccessToken(){
        ...
        const accessTokenMatch = window.location.href.match(/access_tokem=([^&]*)/);
